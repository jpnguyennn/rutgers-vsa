			...
			<div className="mx-5 p-2 min-h-full sticky justify-center items-center lg:p-4">
				...
				<div>
					<Dialog>
						<DialogTrigger>
							<div
								className={`flex justify-center items-center mb-10 p-10 transform transition-transform duration-300 ease-in-out hover:scale-105 hover:rotate-0 bg-white/95 backdrop-blur-sm shadow-2xl border border-white/100 rotate-[--rotation-angle]`}
								id="port_container"
								style={
									{
